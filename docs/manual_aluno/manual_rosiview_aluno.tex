...
\hypersetup{
    ...
    citecolor=rosiblue,
    urlcolor=rosiblue,
    pdftitle={Manual do Usuário - RosiView v0.2.1},
...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small\textcolor{rosigray}{\textbf{RosiView v0.2.1} --- Manual do Usuário}}
...
\begin{titlepage}
    ...
    {\huge \bfseries Manual do Usuário --- Versão v0.2.1}\\[1.8cm]
    ...
    \begin{tcolorbox}[colback=rosilight,colframe=rosiblue,arc=3.5mm,width=0.88\textwidth,center,halign=center]
        ...
        {\normalsize \textbf{Versão da Plataforma:} v0.2.1 (Distribuição Acadêmica)}\\[0.25cm]
