...
$itemsToCopy = @("assets", "css", "js", "scripts", "docs", "launcher", "RosiView.exe", "index.html", "version.json", "manifest.json", "RosiView.vbs", "INICIAR_ROSIVIEW.bat", "bridge", "bridge.bat")
